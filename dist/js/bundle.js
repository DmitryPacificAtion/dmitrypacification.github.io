...
var sliderContainer = $('.card-group.container[data-slider-container="0"]');
var productCards = sliderContainer.find('.product__card');
var i = 0,
    len = productCards.length - 1;
...
productCards.on('click', function (e) {
	...
	if (!e.currentTarget.classList.contains('active')) {
		console.log(e.currentTarget.getAttribute('data-slider-container'));
	}
});
